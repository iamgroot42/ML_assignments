...
if __name__ == "__main__":
	...
	opt_C, opt_gamma = grid_search(EX, EY, 5, SVM_fit_and_predict, 'linear', [1e-2,1e2])
	print SVM_fit_and_predict(EX, EY, EX_, EY_, opt_C, 'linear', opt_gamma, True)
	...
	print SVM_fit_and_predict(train_sampled_X, train_sampled_Y, test_sampled_X, test_sampled_Y, opt_C, 'linear', opt_gamma, True)
	...
	print SVM_fit_and_predict(train_sampled_X, train_sampled_Y, test_sampled_X, test_sampled_Y, opt_C, 'rbf', opt_gamma, True)
